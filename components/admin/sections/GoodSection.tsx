  ...
  return (
    <div className="admin-master-detail">
      <RecordList
        ...
        items={records}
        labelFor={(good) => `${good.id} · ${good.name} · ${good.stockQty}개`}
        onNew={() => onSelect(null)}
        onSelect={onSelect}
      />
      <div className="col" style={{ gap: 16, minWidth: 0 }}>
        <form action={action} className="card col" key={selected ? `catalog-${selected.id}` : 'new-good'} style={{ borderRadius: 10, gap: 14, padding: 18 }}>
