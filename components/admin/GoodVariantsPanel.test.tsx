...
describe('상품 옵션 확인', () => {
  it('선택한 상품의 옵션 가격과 할당 재고를 읽기 전용으로 표시한다', () => {
    const html = renderToStaticMarkup(<GoodVariantsPanel goodId="good-1" variants={[
      { id: 'variant-1', goodId: 'good-1', name: '기본 옵션', price: 12000, stockQty: 3, isDefault: true, archivedAt: null },
      { id: 'variant-2', goodId: 'good-2', name: '다른 상품 옵션', price: 5000, stockQty: 9, isDefault: true, archivedAt: null },
    ]} />);
