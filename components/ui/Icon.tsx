...
const PATHS: Record<string, string> = {
  ...
  bell: 'M6 17h12l-1.5-2.5V10a4.5 4.5 0 0 0-9 0v4.5zM10 20h4',
  /* 로그아웃 — 문에서 나가는 화살표. 전원 기호를 쓰면 「서비스를 끈다」로 읽힌다. */
  signOut: 'M15 4h4v16h-4M14 12H4M8 8l-4 4 4 4',
  settings: 'M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM19 13.5l2 1.5-2 3.5-2.4-1a7.5 7.5 0 0 1-2.1 1.2L14 21h-4l-.5-2.3a7.5 7.5 0 0 1-2.1-1.2l-2.4 1L3 15l2-1.5a7.7 7.7 0 0 1 0-3L3 9l2-3.5 2.4 1a7.5 7.5 0 0 1 2.1-1.2L10 3h4l.5 2.3a7.5 7.5 0 0 1 2.1 1.2l2.4-1L21 9l-2 1.5a7.7 7.7 0 0 1 0 3z',
};
