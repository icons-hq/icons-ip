  ...
  return (
    <div style={{ display: 'grid', placeItems: 'center', minHeight: '100vh', padding: '110px 0 80px' }}>
      <div className="rise" style={{ width: 'min(520px, 92vw)' }}>
        ...
        <form action={profileAction} className="col" style={{ gap: 16, marginTop: 24 }}>
          <div className="col" style={{ gap: 10 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              ...
              <label className="col" htmlFor="settings-avatar" style={{ flex: 1, gap: 7, fontSize: 13.5, color: '#C9C3E4' }}>
                ...
                <input
                  ...
                  aria-describedby={profileState.errors?.avatar ? 'settings-avatar-error' : undefined}
                  aria-invalid={profileState.errors?.avatar ? true : undefined}
                  id="settings-avatar"
                  name="avatar"
                  type="file"
            ...
            <label className="col" htmlFor="settings-nickname" style={{ gap: 7, fontSize: 13.5, color: '#C9C3E4' }}>
              닉네임
              <input
                aria-describedby={profileState.errors?.nickname ? 'settings-nickname-error' : undefined}
                aria-invalid={profileState.errors?.nickname ? true : undefined}
          ...
          <button className="btn btn-holo" disabled={!isConfigured || profilePending} style={{ width: '100%', height: 52, marginTop: 4, fontSize: 15 }}>
        ...
        <form action={marketingAction} className="col" style={{ gap: 16, marginTop: 28 }}>
          ...
          <button className="btn btn-holo" disabled={!isConfigured || marketingPending} style={{ width: '100%', height: 52, marginTop: 4, fontSize: 15 }}>
