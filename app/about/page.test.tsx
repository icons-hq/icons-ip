...
vi.mock('@/components/screens/AboutLegacy', () => ({ AboutLegacy: () => null }));
...
describe('about community personalization', () => {
  beforeEach(() => {
  ...
  it('keeps the public order for guests without reading private follows', async () => {
  ...
  it('does not personalize the surface for an incomplete account', async () => {
    mocks.auth = {
      isConfigured: true,
      user: { id: 'viewer-1', email: 'fan@icons.gg' },
      profile: null,
