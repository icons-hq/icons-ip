...
ICONS는 서브컬처 팬덤을 위한 슈퍼앱 프로토타입이다. 공식 라이선스 **굿즈** 커머스, 수집형 디지털 **카드**(무료 리워드), 오프라인 팝업 티케팅, 캠페인·커뮤니티, IP 허브를 하나의 "White Catalog" 경험(루트 `DESIGN.md`, ADR-0011)으로 묶는다. 어드민 콘솔에는 이전 세대 스타일이 남아 있다.
