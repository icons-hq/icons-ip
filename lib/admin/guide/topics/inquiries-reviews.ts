...
export const INQUIRIES_REVIEWS_TOPIC: AdminGuideTopic = {
  ...
  sections: [
    {
      id: 'faq',
      heading: 'FAQ 관리와 문의 전 안내',
      paragraphs: [
        '반복되는 질문을 FAQ에 등록하고 카테고리와 표시 순서를 정합니다. 공개로 저장한 질문만 고객 도움말(/help)과 문의 제목에 맞춘 추천에 표시됩니다.',
        '초안으로 저장한 질문은 운영자만 검토할 수 있습니다. 다른 운영자가 먼저 고친 항목은 최신 내용을 확인하고 다시 저장합니다.',
      ],
      screens: [{ href: '/admin/cs/faq' }],
    },
    {
      id: 'inquiries',
      heading: '1:1 문의 답변',
      paragraphs: [
        ...
        '답변마다 실제 운영자 표시명이 보입니다. 첫 답변자가 자동 담당자로 배정되며, 담당자와 변경 사유를 입력해 인계하거나 미배정으로 돌릴 수 있습니다. 변경 이력은 감사 로그에 남습니다.',
        '내부 메모는 운영팀만 읽습니다. 고객 대화·알림·메일에 포함되지 않습니다.',
        '미답변 대기가 오래된 순서로 확인하고, 주말 포함 24시간이 지난 문의의 배지를 우선 처리합니다. 답변 뒤 고객의 첫 추가 질문부터 새 대기가 시작되며 연속 추가 질문은 대기 시간을 초기화하지 않습니다. 기존 영업일 24시간 1차 답변 목표와는 별도입니다.',
      ],
      steps: [
