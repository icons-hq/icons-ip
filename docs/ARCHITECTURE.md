...
| posts/comments/likes | 공개 읽기(visible) | 포스트 수정은 작성자 본인 RPC, 삭제·반응과 신고/숨김은 각 최소 권한 RPC |
