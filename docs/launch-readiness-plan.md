...
| 유형 | 갭 → 이슈 |
|---|---|
| A. 스키마만 있고 어드민 경로 없음 | 발급 정책 #99 구현 완료·delivery 검증 대기, 게임 등록 #100 |
...
| **Rewards Ops** | #98 카드풀·확률 콘솔 완료, #99 발급 정책 콘솔 구현 완료·delivery 검증 대기, #100 게임 등록 콘솔 | #99 merge·production 검증 후 완료, #100 즉시 착수 가능 |
