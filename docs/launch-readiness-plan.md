...
- **어드민**: staff/admin 게이트, 카탈로그 upsert 4종, 카드풀 운영 기간·등급별 확률·카드 풀 바인딩, 신고 처리·포스트 숨김, 역할 부여·회수, 주문·배송·환불, 멱등 실재고 입고·보정, 티켓 회차·가격·정원·현장 검표, 실데이터 매출 대시보드 — 전부 audited.
...
| 유형 | 갭 → 이슈 |
|---|---|
| A. 스키마만 있고 어드민 경로 없음 | 뽑기권 정책 #99, 게임 등록 #100 |
...
| **Rewards Ops** | #98 카드풀·확률 콘솔 완료, #99 발급 정책 콘솔, #100 게임 등록 콘솔 | #99·#100 즉시 착수 가능 |
