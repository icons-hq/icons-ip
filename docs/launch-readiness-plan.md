...
| D. 도메인 자체 부재 | 회원 조회·제재 #111, 아트워크 업로드 #112 완료. 카탈로그 보관 #113, 배너·공지·큐레이션 #114 |
...
| **Admin Ops** | #111 회원 조회·제재, #112 아트워크 업로드 완료. #113 카탈로그 보관, #114 배너·공지·큐레이션 | #113→#114 즉시 착수 가능 |

남은 agent-executable 권장 착수 순서: Admin Ops #113→#114. #137 탈퇴 실행은 #102 탈퇴 보존 정책 뒤에 착수하고, #17 소셜 로그인·#87 라이브 결제·#102 탈퇴 보존 정책은 별도 human gate로 닫는다.
