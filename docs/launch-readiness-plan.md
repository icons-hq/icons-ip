...
| 계정 | 프로필 편집(#136)과 로그인·온보딩 보호 마이페이지(#103) 완료. 마이페이지는 signed avatar·닉네임 요약과 주문·티켓·바인더·카드팩·설정 실제 링크, 로그인별 desktop/mobile 진입점을 제공 | #102 [human] 탈퇴 보존 정책 → #137 탈퇴 실행, #17 [human] 소셜 로그인 |
...
남은 agent-executable 권장 착수 순서: ① Notifications → 공지 발송 ② Community·Admin Ops. #137 탈퇴 실행은 #102 탈퇴 보존 정책 뒤에 착수하고, #17 소셜 로그인·#87 라이브 결제·#102 탈퇴 보존 정책은 별도 human gate로 닫는다.
