...
describe('reproducible rehearsal fixtures', () => {
  ...
  it('uses the real template and round trips 30 products with two options', async () => {
    ...
    const plan=planGoodsWorkbookImport(await parseGoodsWorkbook(files['goods-publish.xlsx']),{
      existing:[],ips:[{id:'demo-maple-placeholder',archived_at:null}],presets:[],
      origins:[{id:'00000000-0000-4000-8000-000000042201',code:'gimpo',is_active:true}],
      imageNames:['rehearsal.png'],mediaUrl:path=>path,
    });
